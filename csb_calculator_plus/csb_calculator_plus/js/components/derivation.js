function calculateDerivation() {
    ...
    if (isNaN(orderInput) || orderInput < 1) {
        document.getElementById('result').value = 'Error: The order of the derivative must be a positive integer';
        return;
    }
    ...
    try {
        ...
        document.getElementById('result').value = 'Error: Invalid expression';
    }
}
